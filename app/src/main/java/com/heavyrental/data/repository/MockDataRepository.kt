...
object MockDataRepository {
    ...
    val bookingList: List<Booking> = listOf(
        Booking(
            ...
            items = listOf(
                AssetLine(assetName = "JLG 460SJ Boom Lift", serialNumber = "SN-1A"),
                AssetLine(assetName = "Toyota 8FD25 Forklift", serialNumber = "SN-1B")
            ),
            deliveryNotes = "",
        ...
        Booking(
            ...
            items = listOf(AssetLine(assetName = "Komatsu D65 Bulldozer", serialNumber = "D65EX-18")),
            deliveryNotes = "",
        ...
        Booking(
            ...
            items = listOf(
                AssetLine(assetName = "JLG 1350SJP Telescopic Boom", serialNumber = "1350SJP-01"),
                AssetLine(assetName = "JLG 1350SJP Telescopic Boom", serialNumber = "1350SJP-02")
            ),
        ...
        Booking(
            ...
            items = listOf(AssetLine(assetName = "Volvo EC480E Excavator", serialNumber = "EC480E L")),
            deliveryNotes = "",
        ...
        Booking(
            ...
            items = listOf(AssetLine(assetName = "Liebherr LTM 1100 Mobile Crane", serialNumber = "LTM 1100-5.2")),
            deliveryNotes = "",
        ...
        Booking(
            ...
            items = listOf(AssetLine(assetName = "Toyota 8FBE15 Electric Forklift", serialNumber = "8FBE15")),
        ...
        Booking(
            ...
            items = listOf(AssetLine(assetName = "CAT 320 Hydraulic Excavator", serialNumber = "CAT 320 GC")),
            deliveryNotes = "",
